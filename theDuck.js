...
const makeItRain = () => {
  ...
  // const emojies = ["🎂", "🎉", "🍾"];
  const emojies = ['🎂', '🎉', '🥳', '🎈', '🎊'];
  const animationClasses = ['Animation-a', 'Animation-b', 'Animation-c', 'Animation-d', 'Animation-e'];
...
const selectRandomUserWithComment = () => {
  ...
  const selectedFunFact = randomlySelectValueThatHasNotPreviouslyBeenSelected(devJokes, usedFacts);
